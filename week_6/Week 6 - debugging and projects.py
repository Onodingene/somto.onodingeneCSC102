...
data = {'Name':['Angela', 'Precious', 'Luis', 'Ade','Somto'],
        'Age':[20, 21, 19, 18,20]}
...
# Display the first 7 rows of - Cryptocurrency Predict Artificial Intelligence V3
import pandas as pd
...
# Display the first 7 rows of - Data Set
import pandas as pd
...
# Display the first 3 columns of each data set - Top Apps in Google Play
import pandas as pd
...
# Display the first 3 columns of each data set - Cryptocurrency Predict Artificial Intelligence V3
import pandas as pd
...
# Display the first  rows with header - Top Apps in Google Play
import pandas as pd
...
# Display the first row with header - Cryptocurrency Predict Artificial Intelligence V3
import pandas as pd
...
# Display the first rows with header - Data Set
import pandas as pd
